...
<%@ page import="com.example.dao.UserDAO, com.example.model.User, java.util.List, java.util.Map" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <h1>Subforum List</h1>
        <%
            List<Map<String, Object>> subforums = userDAO.getTable("subforums", new String[]{"SubforumID", "Name", "Description", "CreationDate",
